...
@section('title', 'Editar Subtema - Biblioteca')
...
<div class="topics-container">
    ...
    <div class="topics-header">
        ...
        <a href="{{ route('subtopics_template.index') }}" class="btn-secondary">
            Volver al listado
        </a>
    </div>
        ...
        <div class="topics-form">
            ...
            <div class="form-mode-container" style="display: block; border: 1px solid #ddd; border-radius: 10px; overflow: hidden;">
                <div class="header-topic" style="background-color: #1a3a63;">
                    <h3 style="color: white; margin: 0;">Editar Subtema</h3>
                </div>

                <form method="POST" action="{{ route('subtopics_template.update', $template->id) }}" enctype="multipart/form-data" style="padding: 20px; background: white;">
                    @csrf
                    @method('PUT')

                    <div class="form-group">
                        <label for="title" style="font-weight: bold;">Título del Subtema</label>
