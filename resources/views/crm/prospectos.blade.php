...
<div class="modal-datos-card">
    ...
    <div class="modal-fila-3">
        <div class="modal-campo"><label>Nombre</label><p id="m-tutor-nombre"></p></div>
        <div class="modal-campo"><label>Apellido Paterno</label><p id="m-tutor-paterno"></p></div>
        <div class="modal-campo"><label>Apellido Materno</label><p id="m-tutor-materno"></p></div>
    </div>
    <div class="modal-fila-3">
        <div class="modal-campo"><label>Teléfono 1</label><p id="m-tel1"></p></div>
        <div class="modal-campo"><label>Teléfono 2</label><p id="m-tel2"></p></div>
        <div class="modal-campo"><label>Correo</label><p id="m-tutor-email"></p></div>
    </div>
    <div class="modal-fila-centro">
        <div class="modal-campo"><label>CURP</label><p id="m-tutor-curp"></p></div>
    </div>
 </div>
 ...
 <div class="modal-datos-card">
    ...
    <div class="modal-fila-3">
        <div class="modal-campo"><label>Nombre</label><p id="m-alumno-nombre"></p></div>
        <div class="modal-campo"><label>Apellido Paterno</label><p id="m-alumno-paterno"></p></div>
