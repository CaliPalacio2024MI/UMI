...
@section('content')
<div class="form-container form-container--inscripcion form-container--espera" style="display:flex; align-items:center; justify-content:center; min-height:70vh;">
